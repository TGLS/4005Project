...
public class AlternativeTwoBuilder implements SimulationBuilder {

	public Simulation buildSimulation() {
		Simulation retVal = new Simulation();
		retVal.setRand(new RandomDistribution());
		InspectorOneAlternative a1 = new InspectorOneAlternative(retVal, 50, "Inspector 1A");
		InspectorOneAlternative a3 = new InspectorOneAlternative(retVal, a1.getBuffer1(), "Inspector 1B");
